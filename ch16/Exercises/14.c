...
int main(void){
    ...
    printf("Center od rectangle: %d,%d\n", s.center.x, s.center.y);
    printf("Area of rectangle with height %d and widht %d: %.0f\n", 
...
double compute_area(struct shape s){
    // La forma de calcular el area depende de si es u rectagulo o un cuadrado
